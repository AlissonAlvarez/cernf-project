...
<body>
    ...
    <main class="main_contacto">
        ...
        <section id="contacto" class="seccion_uno_intitucion">
            ...
            <div class="contenido">
                <h1 class="titulo_banner">Inscripción</h1>
                <p>Realiza tu proceso de inscripción en línea</p>
            </div>
        </section>

        <!--================= Formulario de Inscripción =================-->
        <div class="contenido_contacto" id="contenido_inscripcion">
            <h1 class="titulo">Formulario de Inscripción Estudiantil</h1>
            <div class="contact-container" style="max-width: 900px; margin: 0 auto;">
                <h1 class="form-title">Inscríbete Aquí</h1>
                <p class="form-description">
                    Completa el siguiente formulario para iniciar tu proceso de inscripción.
                </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 mb-4 footer_informacion">
                    ...
                    <ul class="list-unstyled">
                        <li><a class="nav-link" href="Controlador.php?accion=inicio">Inicio</a></li>
                        <li><a class="nav-link" href="Controlador.php?accion=institucion">Institución</a></li>
                        <li><a class="nav-link" href="Controlador.php?accion=servicios">Servicios</a></li>
                        <li><a class="nav-link" href="Controlador.php?accion=contacto">Contacto</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 mb-4 footer_informacion">
                    <h5>Servicios</h5>
