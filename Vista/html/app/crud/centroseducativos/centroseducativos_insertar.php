                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-building me-2"></i> Crear Centro Educativo
                        </h2>
                        <p class="text-muted mb-0 small">Registra un nuevo centro educativo en el sistema</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="codigo" id="codigo" placeholder="Ej: CE001"
                                required>
                        </div>

                        <div class="mb-3">
                            <label for="nit" class="form-label">NIT</label>
                            <input type="text" class="form-control" name="nit" id="nit" placeholder="Ej: 123456789-0"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre" id="nombre"
                                placeholder="Nombre del centro educativo" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control" name="correo" id="correo"
                                placeholder="Ej: info@centro.edu.co" required>
                        </div>
