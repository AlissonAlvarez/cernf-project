        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Centro Educativo</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <label>Código</label>
                            <input type="button" class="input_formulario" name="nit" value="<?php echo $datos->obtenerCodigoCentroEducativo(); ?>">				
                        </div>
                        <div class="label_formulario">
                            <label>Nit</label>
                            <input type="button" class="input_formulario" name="nit" value="<?php echo $datos->obtenerNitCentroEducativo(); ?>">				
                        </div>
                        <div class="label_formulario">
                            <label>Nombre</label>
                            <input type="button" class="input_formulario" name="nombre" value="<?php echo $datos->obtenerNombreCentroEducativo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Dirección</label>
                            <input type="button" class="input_formulario" name="direccion" value="<?php echo $datos->obtenerDireccionentroEducativo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Teléfono</label>
                            <input type="button" class="input_formulario" name="telefono" value="<?php echo $datos->obtenerTelefonoentroEducativo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Correo</label>
                            <input type="button" class="input_formulario" name="correo" value="<?php echo $datos->obtenerCorreoentroEducativo(); ?>">
                        </div> 
                    </fieldset>
                </form>
            </div>
