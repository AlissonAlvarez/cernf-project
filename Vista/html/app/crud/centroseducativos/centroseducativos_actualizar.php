                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-building me-2"></i> Actualizar Centro Educativo
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del centro educativo registrado</p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nit" name="nit"
                                value="<?php echo $datos->obtenerNitCentroEducativo(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre</label>
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="<?php echo $datos->obtenerNombreCentroEducativo(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="direccion" class="form-label">Dirección</label>
                            <input type="text" class="form-control" id="direccion" name="direccion"
                                value="<?php echo $datos->obtenerDireccionentroEducativo(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="telefono" class="form-label">Teléfono</label>
                            <input type="tel" class="form-control" id="telefono" name="telefono"
                                value="<?php echo $datos->obtenerTelefonoentroEducativo(); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="correo" class="form-label">Correo</label>
                            <input type="email" class="form-control" id="correo" name="correo"
                                value="<?php echo $datos->obtenerCorreoentroEducativo(); ?>" required>
                        </div>
