    ...
    <body>
        ...
        <main class="main_crud">
            <div class="contenedor_tabla" id="contenedor_crud">
                <h1>Lista del Centro Educativo</h1>
                ...
                <div class="header_tabla">
                    ...
                    <div class="botones_tabla">
                        <form action="buscar_usuario.php" method="get">
                            ...
                            <a href="Controlador.php?accion=centroseducativos_insertar" class="btn_tabla"><span class="icon-plus-square"></span>Agregar</a>
                            <a href="Controlador.php?accion=centroseducativos_pdf" class="btn_tabla"><span class="icon-file-pdf-o"></span>Exportar</a>
                        </form>
                    </div>
                    ...
                    <tbody>
                        ...
                        while ($d = $datos->fetch_object()) {
                            ...
                            <tr>
                                ...
                                <td>' . $d->cencorreo . '</td>
                                <td>
                                    <a href="Controlador.php?accion=centroseducativos_consultar&id=' . $d->codcentroeducativo . '" class="btn_crud"><span class="icon-eye"></span></a>
                                    <a href="Controlador.php?accion=centroseducativos_actualizar&id=' . $d->codcentroeducativo . '" class="btn_crud"><span class="icon-edit"></span></a>
                                    <a href="Controlador.php?accion=centroseducativos_eliminar&id=' . $d->codcentroeducativo . '" class="btn_crud"><span class="icon-trash-o"></span></a>
                                </td>
                            </tr>';
                            array_push($p, $data);
                        }
                ...
                <div class="paginador">
                    <ul>
                        ...
                        for ($j = 1; $j <= $intervalo + 1; $j++) {
                            $c = ($j - 1) * 10;
                            $paginar .= '<li><a href="Controlador.php?accion=modulo_centroseducativos&pagina=' . $c . '">' . $j . '</a></li>';
                        }
                        ?>
                        <?php
                        echo $paginar;
