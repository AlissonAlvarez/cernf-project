        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Calificación</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_calificaciones" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_calificaciones">
                        </div> 
                        <div class="label_formulario">
                            <label>Codigo de la Calificación</label>
                            <input type="text" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoCalificacion(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha de la Calificacion</label>
                            <input type="date" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaCalificacion(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Valor de la Calificacion</label>
                            <input type="text" class="input_formulario" name="valor" value="<?php echo $datos->obtenerValorCalificacion(); ?>">
                        </div>
                        <div class="label_formulario">
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="text" class="input_formulario" name="actividad" value="<?php echo $datos->obtenerCodigoActividad(); ?>">
                        </div>
                        <div class="label_formulario">
