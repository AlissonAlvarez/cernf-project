                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoCalificacion(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha de la Calificacion</label>
                            <input type="button" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaCalificacion(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Valor de la Calificacion</label>
                            <input type="button" class="input_formulario" name="valor" value="<?php echo $datos->obtenerValorCalificacion(); ?>">
                        </div>
                        <div class="label_formulario">
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="actividad" value="<?php echo $datos->obtenerCodigoActividad(); ?>">
                        </div>
                        <div class="label_formulario">
