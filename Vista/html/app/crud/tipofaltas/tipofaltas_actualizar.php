        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Tipo de Falta</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_tipofaltas">
                        </div>
                        <div class="label_formulario">
                            <label>Nombre de Actividad</label>
                            <input type="text" class="input_formulario" name="nombre" value="<?php echo $datos->obtenerNombreTipoFalta(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Descripción de Actividad</label>
                            <input type="text" class="input_formulario" name="descripcion" value="<?php echo $datos->obtenerDescripcionTipoFalta(); ?>">
                        </div>                      
                        <div class="label_formulario">
