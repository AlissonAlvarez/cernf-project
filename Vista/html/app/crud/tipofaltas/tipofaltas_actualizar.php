            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-exclamation-triangle-fill me-2"></i> Actualizar Tipo de Falta
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del tipo de falta registrada</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre de Falta</label>
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="<?php echo $datos->obtenerNombreTipoFalta(); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="descripcion" class="form-label">Descripción de Falta</label>
                            <input type="text" class="form-control" id="descripcion" name="descripcion"
                                value="<?php echo $datos->obtenerDescripcionTipoFalta(); ?>" required>
                        </div>
