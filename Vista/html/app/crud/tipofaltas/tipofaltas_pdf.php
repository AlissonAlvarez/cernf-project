...
$pdf->Ln(16);
$pdf->SetX(45);
$pdf->Cell(270, 10, 'LISTA DE TIPOS DE FALTAS', 1, 1, 'C', 0);
...
while ($fila = $datos->fetch_assoc()){
    $pdf->SetX(95);
    $pdf->Cell(35, 5, $fila ['codtipofalta'], 1, 0, "C");
    $pdf->Cell(55, 5, $fila ['tipfalnombre'], 1, 0, "C");
    $pdf->Cell(55, 5, $fila ['tipfaldescripcion'], 1, 1, "C");
}
