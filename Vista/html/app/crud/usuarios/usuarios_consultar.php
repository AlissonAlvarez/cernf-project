    ...
    <main class="main_crud">
        ...
        <div class="contenedor_formulario" id="contenedor_crud">
            ...
            <div class="botones_tabla">
                <form action="" method="">
                    <a href="Controlador.php?accion=modulo_usuarios" title="Regresar" class="btn_tabla_f"><span
                ...
                <fieldset>
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="button" class="input_formulario" id="nombre" name="nombre"
                            value="<?php echo $datos->obtenerNombreUsuario(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label for="apellido">Contraseña de Usuario</label>
                        <input type="button" class="input_formulario" id="contrasena" name="contrasena"
                            value="<?php echo $datos->obtenerContrasenaUsuario(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label for="fechanacimiento">Identificaciòn de Usuario</label>
                        <input type="button" class="input_formulario" id="identificacion" name="identificacion"
