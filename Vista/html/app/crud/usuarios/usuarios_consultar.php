            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0 small">Visualiza la información del usuario registrado</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <fieldset class="border rounded-3 p-4">
                            <legend class="float-none w-auto px-3 fw-semibold color_icon">Usuario</legend>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Contraseña de Usuario</label>
                                <input type="text" class="form-control" readonly
                                    value="<?php echo $datos->obtenerContrasenaUsuario(); ?>">
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Identificación de Usuario</label>
                                <input type="text" class="form-control" readonly
