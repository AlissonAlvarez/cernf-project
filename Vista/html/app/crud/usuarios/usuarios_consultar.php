        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Usuario</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" id="nombre" name="nombre" value="<?php echo $datos->obtenerNombreUsuario(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="apellido">Contraseña de Usuario</label>
                            <input type="button" class="input_formulario" id ="contrasena" name="contrasena" value="<?php echo $datos->obtenerContrasenaUsuario(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="fechanacimiento">Identificaciòn de Usuario</label>
                            <input type="button" class="input_formulario" id="identificacion" name="identificacion" value="<?php echo $datos->obtenerIdentificacionPersona(); ?>">
                        </div>
                    </fieldset>
                </form>
            </div>
