        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Usuario</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_usuarios" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_usuarios">
                        </div>
                        <div class="label_formulario"
                            <label for="nombre">Nombre de Usuario</label>
                            <input type="text" class="input_formulario" id="nombre" name="nombre" value="<?php echo $datos->obtenerNombreUsuario(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="apellido">Contraseña de Usuario</label>
                            <input type="text" class="input_formulario" id="contrasena" name="contrasena" value="<?php echo $datos->obtenerContrasenaUsuario(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="fechanacimiento">Identificaciòn de Usuario</label>
