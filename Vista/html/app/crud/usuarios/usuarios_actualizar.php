                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-person-fill-gear me-2"></i> Actualizar Usuario
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del usuario registrado</p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="<?php echo $datos->obtenerNombreUsuario(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="contrasena" class="form-label">Contraseña de Usuario</label>
                            <input type="text" class="form-control" id="contrasena" name="contrasena"
                                value="<?php echo $datos->obtenerContrasenaUsuario(); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="identificacion" class="form-label">Identificación de Usuario</label>
