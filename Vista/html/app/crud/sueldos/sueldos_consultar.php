        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Sueldo</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" id="categoria" name="categoria" value="<?php echo $datos->obtenerCategoriaSueldo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="valor">Valor de Sueldo</label>
                            <input type="button" class="input_formulario" id="valor" name="valor"  value="<?php echo $datos->obtenerValorSueldo(); ?>">
                        </div>
                    </fieldset>
                </form>
            </div>
