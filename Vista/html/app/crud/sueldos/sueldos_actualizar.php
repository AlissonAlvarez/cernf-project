                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-cash-stack me-2"></i> Actualizar Sueldo
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del sueldo registrado</p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="categoria" name="categoria"
                                value="<?php echo $datos->obtenerCategoriaSueldo(); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="valor" class="form-label">Valor de Sueldo</label>
                            <input type="text" class="form-control" id="valor" name="valor"
                                value="<?php echo $datos->obtenerValorSueldo(); ?>" required>
                        </div>
