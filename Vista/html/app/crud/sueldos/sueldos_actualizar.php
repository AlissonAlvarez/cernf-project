        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Sueldo</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_sueldos" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_sueldos">
                        </div>
                        <div class="label_formulario">
                            <label for="categoria">Categoría de Sueldo</label>
                            <input type="text" class="input_formulario" id="categoria" name="categoria" value="<?php echo $datos->obtenerCategoriaSueldo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="valor">Valor de Sueldo</label>
                            <input type="text" class="input_formulario" id="valor" name="valor"  value="<?php echo $datos->obtenerValorSueldo(); ?>">
                        </div>
                        <div class="label_formulario">
