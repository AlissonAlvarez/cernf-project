            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-currency-dollar me-2"></i> Crear Sueldo
                        </h2>
                        <p class="text-muted mb-0 small">Registra un nuevo sueldo para el personal</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            <label for="categoria" class="form-label">Categoría de Sueldo</label>
                            <input type="text" class="form-control" id="categoria" name="categoria"
                                placeholder="Ej: Docente" required>
                        </div>

                        <div class="mb-4">
                            <label for="valor" class="form-label">Valor de Sueldo</label>
                            <input type="text" class="form-control" id="valor" name="valor" placeholder="Ej: 1500000"
                                required>
                        </div>
