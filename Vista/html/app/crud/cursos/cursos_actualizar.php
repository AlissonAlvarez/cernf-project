            ...
            <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                <fieldset>
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="text" class="input_formulario" id="codigo" name="codigo"
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="text" class="input_formulario" id="sede" name="sede"
                            value="<?php echo $datos->obtenerCodigoSede(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label for="salon">Código del Salón</label>
                        <input type="text" class="input_formulario" id="salon" name="salon"
                            value="<?php echo $datos->obtenerCodigoSalon(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label for="grado">Código del Grado</label>
                        <input type="text" class="input_formulario" id="grado" name="grado"
