                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-easel2 me-2"></i> Crear Curso
                        </h2>
                        <p class="text-muted mb-0 small">Registra un nuevo curso en el sistema académico</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ej: CURS101"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="salon" name="salon" placeholder="Ej: SAL05"
                                required>
                        </div>

                        <div class="mb-4">
                            <label for="grado" class="form-label">Código del Grado</label>
                            <input type="text" class="form-control" id="grado" name="grado" placeholder="Ej: GRD10"
                                required>
                        </div>
