        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Curso</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_cursos" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" id="codigo" name="codigo" value="<?php echo $datos->obtenerCodigoCurso(); ?>">
                        </div> 
                        <div class="label_formulario">
                            <label for="nombre">Nombre del Curso</label>
                            <input type="button" class="input_formulario" id="nombre" name="nombre" value="<?php echo $datos->obtenerNombreCurso(); ?>">
                        </div> 
                        <div class="label_formulario">
                            <label for="sede">Código de la Sede</label>
                            <input type="button" class="input_formulario" id="sede" name="sede" value="<?php echo $datos->obtenerCodigoSede(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="salon">Código del Salón</label>
                            <input type="button" class="input_formulario" id="salon" name="salon" value="<?php echo $datos->obtenerCodigoSalon(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="grado">Código del Grado</label>
                            <input type="button" class="input_formulario" id="grado" name="grado" value="<?php echo $datos->obtenerCodigoGrado(); ?>">
                        </div>
                    </fieldset>
                </form>
            </div>
