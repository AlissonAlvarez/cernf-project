        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Asignatura</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" id="nombre" name="nombre" value="<?php echo $datos->obtenerNombreAsignatura(); ?>">
                        </div> 
                        <div class="label_formulario">
                            <label for="codigo">Código de Grado</label>
                            <input type="button" class="input_formulario" id="codigo" name="grado" value="<?php echo $datos->obtenerCodigoGrado(); ?>">
                        </div> 
                    </fieldset>
                </form>
            </div>
