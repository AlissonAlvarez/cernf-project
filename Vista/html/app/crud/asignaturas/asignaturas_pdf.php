...
$pdf->Ln(16);
$pdf->SetX(45);
$pdf->Cell(270, 10, 'LISTA DE ASIGNATURAS', 1, 1, 'C', 0);
...
$pdf->Cell(70, 5, "Asignatura", 1, 0, "C");
$pdf->Cell(60, 5, "Grado", 1, 1, "C");

//OBTERNER DATOS DE LA TABLA
$pdf->SetFont("Arial", "", 9);
while ($fila = $datos->fetch_assoc()) {
    $pdf->SetX(85);
    $pdf->Cell(30, 5, $fila ['codasignatura'], 1, 0, "L");
    $pdf->Cell(70, 5, $fila ['asinombre'], 1, 0, "L");
    $pdf->Cell(60, 5, $fila ['granombre'], 1, 1, "L");
}
