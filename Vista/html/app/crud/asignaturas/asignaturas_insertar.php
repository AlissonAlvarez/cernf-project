            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-journal-text me-2"></i> Crear Asignatura
                        </h2>
                        <p class="text-muted mb-0 small">Registra una nueva asignatura en el sistema</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <!-- Código de Grado -->
                        <div class="mb-4">
                            <label for="codigo" class="form-label">Código de Grado</label>
                            <input type="text" class="form-control" id="codigo" name="grado" placeholder="Ej: GRD001"
                                required>
                        </div>
