                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-journal-text me-2"></i> Actualizar Asignatura
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información de la asignatura registrada</p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="<?php echo $datos->obtenerNombreAsignatura(); ?>" required>
                        </div>
