        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Asignatura</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_asignaturas" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_asignaturas">
                        </div>
                        <div class="label_formulario">
                            <label for="codigo">Nombre de Asignatura</label>
                            <input type="text" class="input_formulario" id="nombre" name="nombre" value="<?php echo $datos->obtenerNombreAsignatura(); ?>">
                        </div> 
                        <div class="label_formulario">
                            <label for="codigo">Código de Grado</label>
                            <input type="text" class="input_formulario" id="codigo" name="grado" value="<?php echo $datos->obtenerCodigoGrado(); ?>">
                        </div>                                            
                        <div class="label_formulario">
