        ...
        <div class="container-fluid px-4">
            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-journal-bookmark me-2 color_icon"></i>Lista de Asignaturas
                        </h2>
                        <p class="text-muted mb-0 small">Administra las asignaturas por grado</p>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-3 mt-md-0">
                        ...
                        <a href="Controlador.php?accion=asignaturas_insertar"
                            class="btn btn-primary rounded-pill px-4 btn_app">
                            <i class="bi bi-plus-circle me-1"></i> Agregar
                        </a>
                        <a href="Controlador.php?accion=asignaturas_pdf"
              ...
              while ($d = $datos->fetch_object()) {
                  $data = '
                  <tr>
                      <td class="ps-4 fw-semibold text-dark">' . $d->codasignatura . '</td>
                      <td>' . $d->asinombre . '</td>
                      <td>' . $d->granombre . '</td>
                      <td class="text-center">
                          <div class="d-flex justify-content-center gap-2">
                              <a href="Controlador.php?accion=asignaturas_consultar&id=' . $d->codasignatura . '" class="btn btn-outline-primary action-btn" title="Ver">
                                  <i class="bi bi-eye"></i>
                              </a>
                              <a href="Controlador.php?accion=asignaturas_actualizar&id=' . $d->codasignatura . '" class="btn btn-outline-success action-btn" title="Editar">
                                  <i class="bi bi-pencil"></i>
                              </a>
                              <a href="Controlador.php?accion=asignaturas_eliminar&id=' . $d->codasignatura . '" class="btn btn-outline-danger action-btn" title="Eliminar" >
            ...
            $anteriorLink = ($paginaActual > 1) ? 'Controlador.php?accion=modulo_asignaturas&pagina=' . (($anterior - 1) * 10) : '#';
            ...
            for ($j = 1; $j <= $totalPaginas; $j++) {
                ...
                echo '<li class="page-item ' . $activeClass . '">
                        <a class="page-link pagination-link" href="Controlador.php?accion=modulo_asignaturas&pagina=' . $c . '">' . $j . '</a>
                      </li>';
            }

            $siguiente = min($totalPaginas, $paginaActual + 1);
            $siguienteLink = ($paginaActual < $totalPaginas) ? 'Controlador.php?accion=modulo_asignaturas&pagina=' . (($siguiente - 1) * 10) : '#';
