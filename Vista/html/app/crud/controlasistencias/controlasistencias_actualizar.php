        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Control Asistencia</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_controlasistencias" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_controlasistencias">
                        </div>        
                        <div class="label_formulario">
                            <label>Código de Control de Asistencia</label>
                            <input type="text" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoControlAsistencia(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha & Hora de Asistencia</label>
                            <input type="text" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaControlAsistencia(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Estado</label>
                            <input type="text" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerEstadoControlAsistencia(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Número de Bimestre</label>
                            <input type="text" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerBimestreControlAsistencia(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Observación</label>
                            <input type="text" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerObservacionControlAsistencia(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Estudiante</label>
                            <input type="text" class="input_formulario" name="estudiante" value="<?php echo $datos->obtenerCodigoestudiante(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Docente</label>
                            <input type="text" class="input_formulario" name="docente" value="<?php echo $datos->obtenerCodigoDocente(); ?>">
                        </div>
                        <div class="label_formulario">
