            ...
            <div class="header_tabla">
                ...
                <div class="botones_tabla">
                    <form action="buscar_usuario.php" method="get">
                        ...
                        <a href="Controlador.php?accion=controlasistencias_insertar" class="btn_tabla"><span
                                class="icon-plus-square"></span>Agregar</a>
                        <a href="Controlador.php?accion=controlasistencias_pdf" class="btn_tabla"><span
