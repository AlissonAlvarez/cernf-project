            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-person-lines-fill me-2"></i> Actualizar Acudiente
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del acudiente registrado</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="actualizar_acudientes">
