            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-person-badge-fill me-2"></i> Actualizar Directora
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información de la directora del centro educativo
                        </p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="actualizar_directora">

                        <div class="mb-3">
                            <label for="identificacion" class="form-label">Identificación de Persona</label>
                            <input type="text" class="form-control" id="identificacion" name="identificacion"
                                value="<?php echo $datos->obtenerIdentificacionPersona(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="centroeducativo" class="form-label">Código de Centro Educativo</label>
                            <input type="text" class="form-control" id="centroeducativo" name="centroeducativo"
                                value="<?php echo $datos->obtenerCodigoCentroEducativo(); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="sueldo" class="form-label">Código de Sueldo</label>
                            <input type="text" class="form-control" id="sueldo" name="sueldo"
                                value="<?php echo $datos->obtenerCodigoSueldo(); ?>" required>
                        </div>
