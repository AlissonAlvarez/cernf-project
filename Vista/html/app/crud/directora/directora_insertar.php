            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-person-badge me-2"></i> Crear Directora
                        </h2>
                        <p class="text-muted mb-0 small">Registra los datos de la directora del centro educativo</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="insertar_directora">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="centroeducativo" name="centroeducativo"
                                placeholder="Ej: CE001" required>
                        </div>

                        <div class="mb-4">
                            <label for="sueldo" class="form-label">Código de Sueldo</label>
                            <input type="text" class="form-control" id="sueldo" name="sueldo" placeholder="Ej: SUEL001"
                                required>
                        </div>
