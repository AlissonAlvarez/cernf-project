            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-people-fill me-2"></i> Crear Acudiente X Estudiante
                        </h2>
                        <p class="text-muted mb-0 small">Asocia un acudiente a un estudiante</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="insertar_acudientexestudiante">

                        <div class="mb-4">
                            <label for="codigo" class="form-label">Código de Acudiente X Estudiante</label>
                            <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ej: AXS001"
                                required>
                        </div>

                        <div class="mb-4">
                            <label for="acudiente" class="form-label">Código Acudiente</label>
                            <input type="text" class="form-control" id="acudiente" name="acudiente"
                                placeholder="Ej: ACU123" required>
                        </div>

                        <div class="mb-4">
                            <label for="estudiante" class="form-label">Código Estudiante</label>
                            <input type="text" class="form-control" id="estudiante" name="estudiante"
                                placeholder="Ej: EST456" required>
                        </div>
