        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    ...
                    <input type="hidden" name="accion" value="eliminar_acudientexestudiante">
                    <input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
                    <a href="Controlador.php?accion=modulo_acudientexestudiante" class="btn_cancel">Cancelar</a>
