    ...
    <body>
        ...
        <main class="main_crud">
            <div class="contenedor_tabla" id="contenedor_crud">
                <h1>Lista de Acudiente X Estudiante</h1>
                ...
                <div class="header_tabla">
                    ...
                    <div class="botones_tabla">
                        <form action="buscar_usuario.php" method="get">
                            ...
                            <a href="Controlador.php?accion=acudientexestudiante_insertar" class="btn_tabla"><span class="icon-plus-square"></span>Agregar</a>
                            <a href="Controlador.php?accion=acudientexestudiante_pdf" class="btn_tabla"><span class="icon-file-pdf-o"></span>Exportar</a>
                        </form>
                    </div>
                    ...
                    <tbody>
                        ...
                        while ($d = $datos->fetch_object()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="Controlador.php?accion=acudientexestudiante_consultar&id=' . $d->codacuest . '" class="btn_crud"><span class="icon-eye"></span></a>
                                    <a href="Controlador.php?accion=acudientexestudiante_actualizar&id=' . $d->codacuest . '" class="btn_crud"><span class="icon-edit"></span></a>
                                    <a href="Controlador.php?accion=acudientexestudiante_eliminar&id=' . $d->codacuest . '" class="btn_crud"><span class="icon-trash-o"></span></a>
                                </td>
                            </tr>';
                            array_push($p, $data);
                        }
                ...
                <div class="paginador">
                    <ul>
                        ...
                        for ($j = 1; $j <= $intervalo + 1; $j++) {
                            $c = ($j - 1) * 10;
                            $paginar .= '<li><a href="Controlador.php?accion=modulo_acudientexestudiante&pagina=' . $c . '">' . $j . '</a></li>';
                        }
                        ?>
                        <?php
                        echo $paginar;
