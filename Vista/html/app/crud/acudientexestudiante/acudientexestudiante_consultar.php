                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-search me-2"></i> Consultar Acudiente X Estudiante
                        </h2>
                        <p class="text-muted mb-0 small">Visualiza la información del acudiente asociado a un estudiante
                        </p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <fieldset class="border rounded-3 p-4">
                            <legend class="float-none w-auto px-3 fw-semibold color_icon">Acudiente X Estudiante
                            </legend>

                            <div class="mb-3">
                                <label for="codigo" class="form-label fw-semibold">Código de Acudiente X
                                    Estudiante</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Código Acudiente</label>
                                <input type="text" class="form-control" readonly
                                    value="<?php echo $datos->obtenerCodigoAcudiente(); ?>">
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-semibold">Código Estudiante</label>
                                <input type="text" class="form-control" readonly
