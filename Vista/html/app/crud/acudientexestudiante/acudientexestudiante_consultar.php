        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Acudiente X Estudiante</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" id="codigo" name="codigo" value="<?php echo $datos->obtenerCodigoAcudientexestudiante(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código Acudiente</label>
                            <input type="button" class="input_formulario" name="acudiente" value="<?php echo $datos->obtenerCodigoAcudiente(); ?>">
                        </div>
                        <div class="label_formulario">
