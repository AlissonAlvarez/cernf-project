            ...
            <div class="contenedor_tabla" id="contenedor_crud">
                ...
                <div class="header_tabla">
                    ...
                    <div class="botones_tabla">
                        <form action="buscar_sedes.php" method="get">
                            <a href="Controlador.php?accion=modulos" class="btn_tabla"><span class="icon-th"></span>Módulos</a>
                            <a href="Controlador.php?accion=sedes_insertar" class="btn_tabla"><span class="icon-plus-square"></span>Agregar</a>
                            <a href="Controlador.php?accion=sedes_pdf" class="btn_tabla"><span class="icon-file-pdf-o"></span>Exportar</a>
                        </form>
                    </div>

                    <div class="buscador_tabla">
                        <form action="buscar_sedes.php" method="get" class="form_search">
                ...
                <table>
                    <thead> 
                        <tr>
                            ...
                            <th>Teléfono</th>
                            <th>Correo</th>
                            <th>Código del Centro Educativo</th>
                            <th>Opciones</th>
                        </tr> 
                    </thead>
                    <tbody>
                        ...
                        while ($d = $datos->fetch_object()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="Controlador.php?accion=sedes_consultar&id=' . $d->codsede . '" class="btn_crud"><span class="icon-eye"></span></a>
                                    <a href="Controlador.php?accion=sedes_actualizar&id=' . $d->codsede . '" class="btn_crud"><span class="icon-edit"></span></a>
                                    <a href="Controlador.php?accion=sedes_eliminar&id=' . $d->codsede . '" class="btn_crud"><span class="icon-trash-o"></span></a>
                                </td>
                            </tr>';
                            array_push($p, $data);
                        }
                ...
                <div class="paginador">
                    <ul>
                        ...
                        for ($j = 1; $j <= $intervalo + 1; $j++) {
                            $c = ($j - 1) * 10;
                            $paginar .= '<li><a href="Controlador.php?accion=modulo_sedes&pagina=' . $c . '">' . $j . '</a></li>';
                        }
                        ?>
                        <?php
                        echo $paginar;
