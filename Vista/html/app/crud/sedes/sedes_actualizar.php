                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-building-fill me-2"></i> Actualizar Sede
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información de la sede seleccionada</p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="<?php echo $datos->obtenerNombreSede(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="direccion" class="form-label">Dirección</label>
                            <input type="text" class="form-control" id="direccion" name="direccion"
                                value="<?php echo $datos->obtenerDireccionSede(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="telefono" class="form-label">Teléfono</label>
                            <input type="tel" class="form-control" id="telefono" name="telefono"
                                value="<?php echo $datos->obtenerTelefonoSede(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="correo" class="form-label">Correo</label>
                            <input type="email" class="form-control" id="correo" name="correo"
                                value="<?php echo $datos->obtenerCorreoSede(); ?>" required>
                        </div>

                        <div class="mb-4">
                            <label for="centroeducativo" class="form-label">Código del Centro Educativo</label>
