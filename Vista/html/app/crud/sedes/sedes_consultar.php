                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-search me-2"></i> Consultar Sede
                        </h2>
                        <p class="text-muted mb-0 small">Visualiza la información de una sede registrada</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <fieldset class="border rounded-3 p-4">
                            <legend class="float-none w-auto px-3 fw-semibold color_icon">Sede</legend>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Código del Centro Educativo</label>
                                <input type="text" class="form-control" readonly
