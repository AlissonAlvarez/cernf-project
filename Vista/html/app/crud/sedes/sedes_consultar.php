    ...
    <main class="main_crud">
        ...
        <div class="contenedor_formulario" id="contenedor_crud">
            ...
            <div class="botones_tabla">
                <form action="" method="">
                    <a href="Controlador.php?accion=modulo_sedes" title="Regresar" class="btn_tabla_f"><span
            ...
            <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                <fieldset>
                    ...
                    <div class="label_formulario">
                        <label>Nombre</label>
                        <input type="button" class="input_formulario" name="nombre"
                            value="<?php echo $datos->obtenerNombreSede(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Dirección</label>
                        <input type="button" class="input_formulario" name="direccion"
                            value="<?php echo $datos->obtenerDireccionSede(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Teléfono</label>
                        <input type="button" class="input_formulario" name=telefono
                            value="<?php echo $datos->obtenerTelefonoSede(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Correo</label>
                        <input type="button" class="input_formulario" name="correo"
                            value="<?php echo $datos->obtenerCorreoSede(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Código del Centro Educativo</label>
                        <input type="button" class="input_formulario" name="centroeducativo"
                            value="<?php echo $datos->obtenerCodigoCentroEducativo(); ?>">
                    </div>
                </fieldset>
            </form>
        </div>
