            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-people-fill me-2"></i> Crear Docente X Sede
                        </h2>
                        <p class="text-muted mb-0 small">Registra la asignación de docentes a sedes</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="insertar_docentexsede">

                        <div class="mb-3">
                            <label for="codigo" class="form-label">Código de Docente X Sede</label>
                            <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ej: DX001"
                                required>
                        </div>

                        <div class="mb-3">
                            <label for="docente" class="form-label">Código Docente</label>
                            <input type="text" class="form-control" id="docente" name="docente" placeholder="Ej: DOC123"
                                required>
                        </div>

                        <div class="mb-4">
                            <label for="sede" class="form-label">Código Sede</label>
