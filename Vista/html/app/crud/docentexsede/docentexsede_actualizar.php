                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-building-check me-2"></i> Actualizar Docente X Sede
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la relación entre el docente y la sede correspondiente
                        </p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="codigo" name="codigo"
                                value="<?php echo $datos->obtenerCodigoDocentexSede(); ?>" required>
                        </div>
