        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Docente X Sede</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_docentexsede" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        <legend>DOCENTE X SEDE</legend>                        
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_docentexsede">
                        </div>      
                        <div class="label_formulario">
                            <label for="codigo">Código de Docente X Sede</label>
                            <input type="text" class="input_formulario" id="codigo" name="codigo" value="<?php echo $datos->obtenerCodigoDocentexSede(); ?>">
                        </div>
                        <div class="label_formulario">
