        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Observación</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_observador" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_observador">
                        </div>  
                        <div class="label_formulario">
                            <label>Código de Observador</label>
                            <input type="text" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha</label>
                            <input type="text" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Número de Bimestre</label>
                            <input type="text" class="input_formulario" name="bimestre" value="<?php echo $datos->obtenerBimestreObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Observación</label>
                            <input type="text" class="input_formulario" name="observacion" value="<?php echo $datos->obtenerObservacionObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Tipo Falta</label>
                            <input type="text" class="input_formulario" name="tipofalta" value="<?php echo $datos->obtenerCodigoTipofalta(); ?>">
                        </div>
                        <div class="label_formulario">
