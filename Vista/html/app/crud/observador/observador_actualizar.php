            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-journal-text me-2"></i> Actualizar Observación
                        </h2>
                        <p class="text-muted mb-0 small">Modifica los datos de la observación registrada</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            <label for="codigo" class="form-label">Código de Observador</label>
                            <input type="text" class="form-control" id="codigo" name="codigo"
                                value="<?php echo $datos->obtenerCodigoObservador(); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="fecha" class="form-label">Fecha</label>
                            <input type="text" class="form-control" id="fecha" name="fecha"
                                value="<?php echo $datos->obtenerFechaObservador(); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="bimestre" class="form-label">Número de Bimestre</label>
                            <input type="text" class="form-control" id="bimestre" name="bimestre"
                                value="<?php echo $datos->obtenerBimestreObservador(); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="observacion" class="form-label">Observación</label>
                            <input type="text" class="form-control" id="observacion" name="observacion"
                                value="<?php echo $datos->obtenerObservacionObservador(); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="tipofalta" class="form-label">Código de Tipo Falta</label>
                            <input type="text" class="form-control" id="tipofalta" name="tipofalta"
                                value="<?php echo $datos->obtenerCodigoTipofalta(); ?>" required>
                        </div>
                        <div class="mb-3">
