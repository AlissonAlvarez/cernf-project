                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha</label>
                            <input type="button" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Número de Bimestre</label>
                            <input type="button" class="input_formulario" name="bimestre" value="<?php echo $datos->obtenerBimestreObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Observación</label>
                            <input type="button" class="input_formulario" name="observacion" value="<?php echo $datos->obtenerObservacionObservador(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Tipo Falta</label>
                            <input type="button" class="input_formulario" name="tipofalta" value="<?php echo $datos->obtenerCodigoTipofalta(); ?>">
                        </div>
                        <div class="label_formulario">
