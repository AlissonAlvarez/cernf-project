            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-pencil-square me-2"></i> Crear Observación
                        </h2>
                        <p class="text-muted mb-0 small">Registra observaciones académicas de estudiantes</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="insertar_observador">

                        <div class="mb-3">
                            <label for="codigo" class="form-label">Código de Observador</label>
                            <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ej: OBS001"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="observacion" name="observacion" rows="3"
                                placeholder="Escriba la observación aquí..." required></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="docente" name="docente" placeholder="Ej: DOC001"
                                required>
                        </div>
