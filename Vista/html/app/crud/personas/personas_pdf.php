...
$pdf->Ln(16);
$pdf->SetX(45);
$pdf->Cell(270, 10, 'LISTA DE PERSONAS', 1, 1, 'C', 0);
...
while ($fila = $datos->fetch_object()) {
    ...
    $pdf->Cell(30, 5, $fila->perrol, 1, 0, "L");
    $pdf->Cell(30, 5, $fila->pergenero, 1, 0, "L");
    $pdf->Cell(30, 5, $fila->perfechanacimiento, 1, 0, "L");
    $pdf->Cell(60, 5, $fila->perdireccion, 1, 0, "L");
    $pdf->Cell(30, 5, $fila->pertelefono, 1, 0, "L");
