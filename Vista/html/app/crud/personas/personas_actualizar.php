                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="text" class="input_formulario" id="identificacion" name="identificacion" value="<?php echo $datos->obtenerIdentificacionPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="nombre">Nombres</label>
                            <input type="text" class="input_formulario" id="nombre" name="nombre" value="<?php echo $datos->obtenerNombrePersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="apellido">Apellidos</label>
                            <input type="text" class="input_formulario" id="apellido" name="apellido" value="<?php echo $datos->obtenerApellidoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Rol</label>
                            <input type="text" class="input_formulario" id="rol" name="rol" value="<?php echo $datos->obtenerRolPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Género</label>
                            <input type="text" class="input_formulario" id="genero" name="genero" value="<?php echo $datos->obtenerGeneroPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="nacimiento">Fecha de Nacimiento</label>
                            <input type="date" class="input_formulario" id="fechanacimiento" name="fechanacimiento" value="<?php echo $datos->obtenerFechaNacimientoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="direccion">Dirección</label>
                            <input type="text" class="input_formulario" id="direccion" name="direccion" value="<?php echo $datos->obtenerDireccionPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="telefono">Teléfono</label>
                            <input type="tel" class="input_formulario" id="telefono" name="telefono" value="<?php echo $datos->obtenerTelefonoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label for="correo">Correo</label>
                            <input type="email" class="input_formulario" id="correo" name="correo" value="<?php echo $datos->obtenerCorreoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
