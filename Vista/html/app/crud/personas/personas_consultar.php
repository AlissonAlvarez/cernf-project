            ...
            <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                <fieldset>
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="button" class="input_formulario" name="apellido"
                            value="<?php echo $datos->obtenerApellidoPersona(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Rol</label>
                        <input type="button" class="input_formulario" name="rol"
                            value="<?php echo $datos->obtenerRolPersona(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Género</label>
                        <input type="button" class="input_formulario" name="genero"
                            value="<?php echo $datos->obtenerGeneroPersona(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Fecha de Nacimiento</label>
                        <input type="button" class="input_formulario" name="nacimiento"
