        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Persona</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="identificacion" value="<?php echo $datos->obtenerIdentificacionPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Nombres</label>
                            <input type="button" class="input_formulario" name="nombre" value="<?php echo $datos->obtenerNombrePersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Apellidos</label>
                            <input type="button" class="input_formulario" name="apellido" value="<?php echo $datos->obtenerApellidoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Rol</label>
                            <input type="button" class="input_formulario" name="rol" value="<?php echo $datos->obtenerRolPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Género</label>
                            <input type="button" class="input_formulario" name="genero" value="<?php echo $datos->obtenerGeneroPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha de Nacimiento</label>
                            <input type="button" class="input_formulario" name="nacimiento" value="<?php echo $datos->obtenerFechaNacimientoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Dirección</label>
                            <input type="button" class="input_formulario" name="direccion" value="<?php echo $datos->obtenerDireccionPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Télefono</label>
                            <input type="button" class="input_formulario" name="telefono" value="<?php echo $datos->obtenerTelefonoPersona(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Correo</label>
                            <input type="button" class="input_formulario" name="correo"value="<?php echo $datos->obtenerCorreoPersona(); ?>">
                        </div>                    
                    </fieldset>
                </form>
            </div>
