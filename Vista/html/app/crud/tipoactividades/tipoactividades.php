        ...
        <div class="container-fluid px-4">
            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-list-task me-2 color_icon"></i> Lista de Tipos de Actividades
                        </h2>
                        <p class="text-muted mb-0 small">Administra todas las actividades registradas en el sistema</p>
                    </div>
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-3 mt-md-0">
                        ...
                        <a href="Controlador.php?accion=tipoactividades_insertar"
                            class="btn btn-primary rounded-pill px-4 btn_app">
                            <i class="bi bi-plus-circle me-1"></i> Agregar
                        </a>
                        <a href="Controlador.php?accion=tipoactividades_pdf"
              ...
              while ($d = $datos->fetch_object()) {
                  $data = '
                  <tr>
                      <td class="ps-4 fw-semibold text-dark">' . $d->codtipoactividad . '</td>
                      <td class="text-capitalize">' . $d->tipactnombre . '</td>
                      <td>' . $d->tipactdescripcion . '</td>
                      <td class="text-center">
                          <div class="d-flex justify-content-center gap-2">
                              <a href="Controlador.php?accion=tipoactividades_consultar&id=' . $d->codtipoactividad . '" class="btn btn-outline-primary action-btn" title="Ver">
                                  <i class="bi bi-eye"></i>
                              </a>
                              <a href="Controlador.php?accion=tipoactividades_actualizar&id=' . $d->codtipoactividad . '" class="btn btn-outline-success action-btn" title="Editar">
                                  <i class="bi bi-pencil"></i>
                              </a>
                              <a href="Controlador.php?accion=tipoactividades_eliminar&id=' . $d->codtipoactividad . '" class="btn btn-outline-danger action-btn" title="Eliminar">
            ...
            $anteriorLink = ($paginaActual > 1) ? 'Controlador.php?accion=modulo_tipoactividades&pagina=' . (($anterior - 1) * 10) : '#';
            ...
            for ($j = 1; $j <= $totalPaginas; $j++) {
                ...
                echo '<li class="page-item ' . $activeClass . '">
                        <a class="page-link pagination-link" href="Controlador.php?accion=modulo_tipoactividades&pagina=' . $c . '">' . $j . '</a>
                      </li>';
            }

            // Siguiente
            $siguiente = min($totalPaginas, $paginaActual + 1);
            $siguienteLink = ($paginaActual < $totalPaginas) ? 'Controlador.php?accion=modulo_tipoactividades&pagina=' . (($siguiente - 1) * 10) : '#';
