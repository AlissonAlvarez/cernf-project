    ...
    <body>
        ...
        <main class="main_crud">
            <div class="contenedor_tabla" id="contenedor_crud">
                <h1>Lista Tipo de Actividades</h1>
                ...
                <div class="header_tabla">
                    ...
                    <div class="botones_tabla">
                        <form action="buscar_usuario.php" method="get">
                            ...
                            <a href="Controlador.php?accion=tipoactividades_insertar" class="btn_tabla"><span class="icon-plus-square"></span>Agregar</a>
                            <a href="Controlador.php?accion=tipoactividades_pdf" class="btn_tabla"><span class="icon-file-pdf-o"></span>Exportar</a>
                        </form>
                    </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        while ($d = $datos->fetch_object()) {
                            $data = '
                            <tr>
                                <td> ' . $d->codtipoactividad . '</td>
                                <td>' . $d->tipactnombre . '</td>
                                <td>' . $d->tipactdescripcion . '</td>
                                <td>
                                    <a href="Controlador.php?accion=tipoactividades_consultar&id=' . $d->codtipoactividad . '" class="btn_crud"><span class="icon-eye"></span></a>
                                    <a href="Controlador.php?accion=tipoactividades_actualizar&id=' . $d->codtipoactividad . '" class="btn_crud"><span class="icon-edit"></span></a>
                                    <a href="Controlador.php?accion=tipoactividades_eliminar&id=' . $d->codtipoactividad . '" class="btn_crud"><span class="icon-trash-o"></span></a>
                                </td>
                            </tr>';
                            array_push($p, $data);
                        }
                ...
                <div class="paginador">
                    <ul>
                        ...
                        for ($j = 1; $j <= $intervalo + 1; $j++) {
                            $c = ($j - 1) * 10;
                            $paginar .= '<li><a href="Controlador.php?accion=modulo_tipoactividades&pagina=' . $c . '">' . $j . '</a></li>';
                        }
                        ?>
                        <?php
                        echo $paginar;
