                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-list-task me-2"></i> Crear Tipo de Actividad
                        </h2>
                        <p class="text-muted mb-0 small">Registra un nuevo tipo de actividad</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ej: Deporte"
                                required>
                        </div>
