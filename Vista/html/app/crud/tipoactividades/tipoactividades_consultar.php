        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Tipo de Actividad</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_tipoactividades" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="nombre" value="<?php echo $datos->obtenerNombreTipoActividad(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Descripción de Actividad</label>
                            <input type="button" class="input_formulario" name="descripcion" value="<?php echo $datos->obtenerDescripcionTipoActividad(); ?>">
                        </div>
                    </fieldset>
                </form>
            </div>
