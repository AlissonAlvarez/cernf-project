...
$pdf->Ln(16);
$pdf->SetX(45);
$pdf->Cell(270, 10, 'LISTA DE TIPO DE ACTIVIDADES', 1, 1, 'C', 0);
...
$pdf->Cell(55, 5, "Descripcion", 1, 1, "C");
...
while ($fila = $datos->fetch_assoc()){
    $pdf->SetX(95);
    $pdf->Cell(35, 5, $fila ['codtipoactividad'], 1, 0, "C");
    $pdf->Cell(55, 5, $fila ['tipactnombre'], 1, 0, "C");
    $pdf->Cell(55, 5, $fila ['tipactdescripcion'], 1, 1, "C");
}
