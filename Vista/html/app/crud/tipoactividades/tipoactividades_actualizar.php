                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="text" class="input_formulario" name="nombre" value="<?php echo $datos->obtenerNombreTipoActividad(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Descripción de Actividad</label>
                            <input type="text" class="input_formulario" name="descripcion" value="<?php echo $datos->obtenerDescripcionTipoActividad(); ?>">
                        </div>
                        <div class="label_formulario">
