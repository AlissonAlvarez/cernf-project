        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Docente</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="fechaingreso" value="<?php echo $datos->obtenerFechaIngresoDocente(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Año de Vigencia</label>
                            <input type="button" class="input_formulario" name="vigencia" value="<?php echo $datos->obtenerVigenciaDocente(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Sueldo</label>
                            <input type="button" class="input_formulario" name="sueldo" value="<?php echo $datos->obtenerCodigoSueldo(); ?>">
                        </div>
                        <div class="label_formulario">
