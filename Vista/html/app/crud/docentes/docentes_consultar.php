            ...
            <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                <fieldset>
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="button" class="input_formulario" name="fechaingreso"
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="button" class="input_formulario" name="sueldo"
                            value="<?php echo $datos->obtenerCodigoSueldo(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Identificación de Persona</label>
                        <input type="button" class="input_formulario" name="identificacion"
