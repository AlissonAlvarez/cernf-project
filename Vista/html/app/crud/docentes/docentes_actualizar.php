    ...
    <main class="main_crud">
        ...
        <div class="contenedor_formulario" id="contenedor_crud">
            ...
            <div class="botones_tabla">
                <form action="" method="">
                    <a href="Controlador.php?accion=modulo_docentes" title="Regresar" class="btn_tabla_f"><span
            ...
            <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                <fieldset>
                    ...
                    <div class="label_formulario">
                        ...
                        <input type="date" class="input_formulario" name="fechaingreso"
                            value="<?php echo $datos->obtenerFechaIngresoDocente(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Año de Vigencia</label>
                        <input type="date" class="input_formulario" name="vigencia"
                            value="<?php echo $datos->obtenerVigenciaDocente(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Código de Sueldo</label>
                        <input type="text" class="input_formulario" name="sueldo"
                            value="<?php echo $datos->obtenerCodigoSueldo(); ?>">
                    </div>
                    <div class="label_formulario">
                        <label>Identificación de Persona</label>
                        <input type="text" class="input_formulario" name="identificacion"
