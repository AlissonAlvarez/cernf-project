                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-person-workspace me-2"></i> Actualizar Docente
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del docente registrado</p>
                    </div>
