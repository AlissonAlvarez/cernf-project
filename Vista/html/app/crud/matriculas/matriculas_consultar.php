        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Matrícula</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="numero" value="<?php echo $datos->obtenerNumeroMatricula(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha de Matrícula</label>
                            <input type="button" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaMatricula(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Año de Vigencia</label>
                            <input type="button" class="input_formulario" name="vigencia" value="<?php echo $datos->obtenerVigenciaMatricula(); ?>">
                        </div>
                        <div class="label_formulario">
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="sede" value="<?php echo $datos->obtenerCodigoSede(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Grado</label>
                            <input type="button" class="input_formulario" name="grado" value="<?php echo $datos->obtenerCodigoGrado(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Curso</label>
                            <input type="button" class="input_formulario" name="curso" value="<?php echo $datos->obtenerCodigoCurso(); ?>">
                        </div>
                    </fieldset>
                </form>
            </div>
