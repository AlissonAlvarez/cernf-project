            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-journal-check me-2"></i> Crear Matrícula
                        </h2>
                        <p class="text-muted mb-0 small">Registra la matrícula de un estudiante en el sistema académico
                        </p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        <input type="hidden" name="accion" value="insertar_matriculas">

                        <div class="mb-3">
                            <label for="numero" class="form-label">Número de Matrícula</label>
                            <input type="text" class="form-control" id="numero" name="numero" placeholder="Ej: MAT001"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="vigencia" class="form-label">Año de Vigencia</label>
                            <input type="text" class="form-control" id="vigencia" name="vigencia" placeholder="Ej: 2025"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="sede" class="form-label">Código de Sede</label>
                            <input type="text" class="form-control" id="sede" name="sede" placeholder="Ej: SED001"
                                required>
                        </div>

                        <div class="mb-3">
                            <label for="grado" class="form-label">Código de Grado</label>
                            <input type="text" class="form-control" id="grado" name="grado" placeholder="Ej: GRD001"
                                required>
                        </div>

                        <div class="mb-4">
                            <label for="curso" class="form-label">Código de Curso</label>
                            <input type="text" class="form-control" id="curso" name="curso" placeholder="Ej: CUR001"
                                required>
                        </div>
