        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Matrícula</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_matriculas" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_matriculas">
                        </div>
                        <div class="label_formulario">
                            <label>Número de Matrícula</label>
                            <input type="text" class="input_formulario" name="numero" value="<?php echo $datos->obtenerNumeroMatricula(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Fecha de Matrícula</label>
                            <input type="text" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaMatricula(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Año de Vigencia</label>
                            <input type="text" class="input_formulario" name="vigencia" value="<?php echo $datos->obtenerVigenciaMatricula(); ?>">
                        </div>
                        <div class="label_formulario">
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="text" class="input_formulario" name="sede" value="<?php echo $datos->obtenerCodigoSede(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Grado</label>
                            <input type="text" class="input_formulario" name="grado" value="<?php echo $datos->obtenerCodigoGrado(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Curso</label>
                            <input type="text" class="input_formulario" name="curso" value="<?php echo $datos->obtenerCodigoCurso(); ?>">
                        </div>
                        <div class="label_formulario">
