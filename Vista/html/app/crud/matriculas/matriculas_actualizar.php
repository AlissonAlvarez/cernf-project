                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-file-earmark-text-fill me-2"></i> Actualizar Matrícula
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información de la matrícula del estudiante</p>
                    </div>
