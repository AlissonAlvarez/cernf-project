                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-building me-2"></i> Crear Salón
                        </h2>
                        <p class="text-muted mb-0 small">Registra un nuevo salón para la institución</p>
                    </div>
                ...
                <div class="card-form text-center p-4 p-md-5">
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ej: Salón A"
                                required>
                        </div>

                        <div class="mb-4">
                            <label for="sede" class="form-label">Código de la Sede</label>
                            <input type="text" class="form-control" id="sede" name="sede" placeholder="Ej: S001"
                                required>
                        </div>
