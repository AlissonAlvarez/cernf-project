        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Acuerdo</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoAcuerdo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Tipo de Acuerdo</label>
                            <input type="button" class="input_formulario" name="tipo" value="<?php echo $datos->obtenerTipoAcuerdo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Observación</label>
                            <input type="button" class="input_formulario" name="observacion" value="<?php echo $datos->obtenerObservacionAcuerdo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código del Observador</label>
                            <input type="button" class="input_formulario" name="observador" value="<?php echo $datos->obtenerCodigoObservador(); ?>">
                        </div>
                    </fieldset>
                </form>
            </div>
