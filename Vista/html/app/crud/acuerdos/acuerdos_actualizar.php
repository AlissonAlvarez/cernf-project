                ...
                <div
                    ...
                    <div>
                        <h2 class="color_icon fw-bold mb-1">
                            <i class="bi bi-file-earmark-text me-2"></i> Actualizar Acuerdo
                        </h2>
                        <p class="text-muted mb-0 small">Modifica la información del acuerdo registrado</p>
                    </div>
                    ...
                    <form action="Controlador.php" method="POST" class="text-start">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="codigo" name="codigo"
                                value="<?php echo $datos->obtenerCodigoAcuerdo(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="tipo" class="form-label">Tipo de Acuerdo</label>
                            <input type="text" class="form-control" id="tipo" name="tipo"
                                value="<?php echo $datos->obtenerTipoAcuerdo(); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="observacion" class="form-label">Observación</label>
                            <input type="text" class="form-control" id="observacion" name="observacion"
                                value="<?php echo $datos->obtenerObservacionAcuerdo(); ?>" required>
                        </div>
