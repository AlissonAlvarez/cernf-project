        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Actualizar Acuerdo</h2><br>
                </div>

                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_acuerdos" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            <input type="hidden"name="accion" value="actualizar_acuerdos">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Acuerdo</label>
                            <input type="text" class="input_formulario" name="codigo" value="<?php echo $datos->obtenerCodigoAcuerdo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Tipo de Acuerdo</label>
                            <input type="text" class="input_formulario" name="tipo" value="<?php echo $datos->obtenerTipoAcuerdo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Observación</label>
                            <input type="text" class="input_formulario" name="observacion" value="<?php echo $datos->obtenerObservacionAcuerdo(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código del Observador</label>
                            <input type="text" class="input_formulario" name="observador" value="<?php echo $datos->obtenerCodigoObservador(); ?>">
                        </div>
                        <div class="label_formulario">
