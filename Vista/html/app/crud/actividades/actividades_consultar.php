        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="titulo_formulario">
                    <h2 align="center">Consultar Actividad</h2><br>
                </div>
                ...
                <form class="form_formulario" id="" name="" action="Controlador.php" method="POST">
                    <fieldset>
                        ...
                        <div class="label_formulario">
                            ...
                            <input type="button" class="input_formulario" name="fecha" value="<?php echo $datos->obtenerFechaActividad(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Número de Bimestre</label>
                            <input type="button" class="input_formulario" name="bimestre" value="<?php echo $datos->obtenerBimestreActividad(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código de Asignatura</label>
                            <input type="button" class="input_formulario" name="asignatura" value="<?php echo $datos->obtenerCodigoAsignatura(); ?>">
                        </div>
                        <div class="label_formulario">
                            <label>Código del Tipo de Actividades</label>
                            <input type="button" class="input_formulario" name="tipoactividad"value="<?php echo $datos->obtenerCodigoTipoActividad(); ?>">
                        </div> 
                    </fieldset>
                </form>
            </div>
