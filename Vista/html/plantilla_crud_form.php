        ...
        <main class="main_crud">
            ...
            <div class="contenedor_formulario" id="contenedor_crud">
                ...
                <div class="botones_tabla">
                    <form action="" method="">
                        <a href="Controlador.php?accion=modulo_" title="Regresar"class="btn_tabla_f"><span class="icon-folder-open-o"></span></a>
                    </form>

                </div>

                <form class="form_formulario" id="" name="" action="Controlador.php?accion=" method="POST">
                    <fieldset>
                        <legend></legend>
