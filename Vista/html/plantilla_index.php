...
<html lang="es">
    ...
    <head>
        ...
        <ttle><?php echo PROYECTO; ?></title>i
            ...
            <section id="contentido">
                <div class="flexslider">
                    <ul class="slides">
                        ...
                        <li>
                            <img src="vista/imagenes/banner1.png" alt="">
                            <section class="caption"></section>
                        </li>

                        <li>
                            <img src="vista/imagenes/banner2.png" alt="">
                            <section class="caption"></section>
                        </li>

                        <li>
                            <img src="vista/imagenes/banner3.png" alt="">
                            <section class="caption"></section>
                        </li>

                        <li>
                            <img src="vista/imagenes/banner4.png" alt="">
                            <section class="caption"></section>
                        </li>

                        <li>
                            <img src="vista/imagenes/banner5.png" alt="">
                            <section class="caption"></section>
                        </li>
